<template>
  ...
  <button
    class="align-middle text-center font-normal no-underline btn-white md:px-12 md:py-2 bg-gray-600 text-white hover:bg-gray-700 leading-tight text-xs content-content-text"
    :class="{
